...
class ResponseCodes
{
    ...
    const RESPONSE_CODE_API_TOKEN_BLOCKED = 86;
    const RESPONSE_CODE_API_TOKEN_INVALID = 87;
    const RESPONSE_CODE_API_TOKEN_PLATFORM = 88;
    const RESPONSE_CODE_API_TOKEN_DEBUG_ON_PROD = 89;
